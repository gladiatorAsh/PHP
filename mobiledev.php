      ...
      <div class="container">
        <div class="row tpmg45">
          <div class="col-lg-12 text-center">
            ...
            <h3 class="section-subheading text-muted">Mobile is the way of the future</h3>
          </div>
        </div>
        <div class="row">
          <div class="col-md-5 col-sm-6 portfolio-item">
            <img src="images/mobile.jpg" class="img-responsive" alt="project1">
          </div>
          <div class="col-md-4 col-sm-6 portfolio-item">
            <p>
              With a rare mix of domain knowledge, technology, project management experts and expertise in Application Development & Technology Solutions, we bring in a dedicated team to work on each project with excellence.
            </p>
            <h4>Our offerings : </h4>
            <ul>
              <li>Android</li>
              <li>iOS</li>
              <li>Windows Phone</li>
              <li>Hybrid Apps (Phonegap)</li>
            </ul>
             <input id="mobiledev.php" type="hidden" class="rating rate"  data-filled="fa fa-star fa-3x" data-empty="fa fa-star-o fa-3x" data-fractions="2"/>
