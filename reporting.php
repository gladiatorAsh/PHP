      ...
      <div class="container">
        <div class="row tpmg45">
          ...
          <div class="col-lg-12 text-center">
            <h2 class="section-heading">Data Warehousing and Reports</h2>
            <h3 class="section-subheading text-muted">A picture says a thousand words</h3>
          </div>
        </div>

        <div class="row">
          <div class="col-md-5 col-sm-6 portfolio-item">
            <img src="images/reports.jpg" class="img-responsive" alt="project1">
          </div>
