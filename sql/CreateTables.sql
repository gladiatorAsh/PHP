...
Create table services(id integer primary key ,url varchar(100) unique NOT NULL CHECK (url <> ''),title varchar(100) ,subtitle varchar(100),img varchar(200), description varchar(5000),total_ratings numeric DEFAULT 0,no_ratings int DEFAULT 0,no_visits int DEFAULT 0);
...
insert into services(id,url,title,subtitle,img,description) values(2,'consulting.php','IT SOFTWARE CONSULTING SERVICES','Customer needs are kept before technical challenges','http://codewarriors.herokuapp.com/img/portfolio/treehouse.png','We provide Database Design, Class and Interface Design, Consulting in selection of Suitable Framework and Technology, Inter-application Communication Strategies, Open Source System, General System Architecture, and tools to solve problems. Our System Audit helps client’s business to identify design flaws through suggestion of remedies.');
