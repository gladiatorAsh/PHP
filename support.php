      ...
      <div class="container">
        <div class="row tpmg45">
          <div class="col-lg-12 text-center">
            <h2 class="section-heading">Maintenance and Support</h2>
            <h3 class="section-subheading text-muted">The support you can count on</h3>
          </div>
        </div>
        <div class="row">
          <div class="col-md-5 col-sm-6 portfolio-item">
            <img src="images/support.jpg" class="img-responsive" alt="project1">
          </div>
          <div class="col-md-4 col-sm-6 portfolio-item">
            <p>
              We offer a range of specialised services to help you maintain continuous service (24x7) and achieve your desired business outcomes without compromising on quality while adhering to your time and budget constraints.
            </p>
             <input id="support.php" type="hidden" class="rating rate"  data-filled="fa fa-star fa-3x" data-empty="fa fa-star-o fa-3x" data-fractions="2"/>

          </div>
          <a href="mobiledev.php">Next >>>></a>
