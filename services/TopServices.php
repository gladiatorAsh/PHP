    ...
    or die('Could not connect: ' . pg_last_error());
      ...
      //  mysql_select_db($db_name);
        $searchquery="select COALESCE(total_ratings / NULLIF(no_ratings,0), 0) as avg_rating ,* from services order by COALESCE(total_ratings / NULLIF(no_ratings,0), 0) desc LIMIT 4;";
