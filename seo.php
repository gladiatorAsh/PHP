      ...
      <div class="container">
        <div class="row tpmg45">
          <div class="col-lg-12 text-center">
            ...
            <h3 class="section-subheading text-muted">If you can't google it, it doesn't exist</h3>
          </div>
        </div>

        <div class="row">
          <div class="col-md-4 col-sm-6 portfolio-item">
            <img src="images/seo.png" class="img-responsive" alt="project1">
          </div>
          <div class="col-md-7 col-sm-6 portfolio-item">
            <h4> Our SEO services</h4>
            <p>
              We offer a refreshingly transparent approach to online success through sound Search Engine Optimization advice that produces quantifiable, measurable and dependable results for our clients across the United States and around the world. Discover more about
              how our SEO services can grow your online visibility and drive your website revenues…
            </p>
            <h4> SEO Consultants </h4>
            <p>Our Consultancy SEO services provide research, analysis and recommendations for all websites, but especially for those having difficulty with their Search Engine visibility.
            </p>
            <h4>SEO Audits</h4>
            <p>
              Our Search Engine Optimization Audits identify opportunities and issues; we examine technical, on-page and off-page elements and your competition, delivering SEO services for your online success.
            </p>

            <h4>SEO Packages and Plans</h4>
            <p>
